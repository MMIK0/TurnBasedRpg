...
public class ItemButtons : MonoBehaviour
{
    ...
    public void Press()
    {
        ...
        if (Shop.instance.shopMenu.activeInHierarchy)
        {
            ...
            {
                Shop.instance.SelectSellItem(GameManager.instance.GetItemDetails(GameManager.instance.itemsHeld[buttonValue]), GameManager.instance.numberOfItems[buttonValue]);
            }
        }
    }
}
