...
public class GameMenu : MonoBehaviour
{
    ...
    public void StatusChar(int selected)
    {
        ...
        statusDef.text = playerStats[selected].Armor.ToString();
        ...
        statusWpnPwr.text = playerStats[selected].wpnPower.ToString();
        ...
        statusArmrPwr.text = playerStats[selected].armrPower.ToString();
